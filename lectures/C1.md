...
3. Programmation en ressources limitées (Eric Petit)
...
4. Systèmes temps-réel
   ...
   * Scrutation active ou interruptions 
...
5. Programmation sans Système d'exploitation 
...
Comment est codée la valeur 2**31 ?
